using ApiProjeCampWebUI.Dtos.MessageDto;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;
using System.Net.Http.Headers;
using System.Text;
using System.Text.Json;
using static ApiProjeCampWebUI.Controllers.AIController;
...
namespace ApiProjeCampWebUI.Controllers
{
    public class MessageController : Controller
    {
        ...
        public async Task<IActionResult> MessageList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7260/api/Messages");
        ...
        public async Task<IActionResult> CreateMessage(CreateMessageDto createMessageDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7260/api/Messages",
                stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7260/api/Messages?id=" + id);
            return RedirectToAction("MessageList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7260/api/Messages/GetMessage?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateMessage(UpdateMessageDto updateMessageDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7260/api/Messages/", stringContent);
            return RedirectToAction("MessageList");
        }
            ...
            var requestData = new
            {
                ...
                messages = new[]
                {
                    new
                    {
                        ...
                        "müşteri memnuniyeti gözeten cevaplar veren  bir yapak zeka aracısın." +
                    "Amacımız kullanıcı tarafından girilen mesajlara en olumlu ve mantıklı cevapalar sunabilmek"
                    },
                    new
                    {
                        role = "user",
        ...
        public async Task<IActionResult> SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            try
            {
                ...
                var toxicResponse = await client.PostAsync("https://api-inference.huggingface.co/models/toxic-bert", toxicContent);
            ...
            var jsonData = JsonConvert.SerializeObject(createMessageDto);
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client2.PostAsync("https://localhost:7260/api/Messages",
                stringContent);
